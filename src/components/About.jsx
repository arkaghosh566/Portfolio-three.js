        ...
        >
          ...
          <div className="mt-10 flex flex-wrap gap-5 justify-center">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={
                () => window.open("https://github.com/arkaghosh566", "_blank") // UPDATED
              }
            >
        ...
        >
          ...
          >
            ...
            >
              ...
              <span>
                I&apos;m a skilled **Machine Learning Engineer** with over a
                year of experience developing end-to-end solutions using
                **Python**, **TensorFlow**, and **PyTorch**. My expertise is in
            ...
            >
              <span className="mr-4 text-2xl flex-shrink-0">🎓</span>
              <span>
                I recently graduated with a **B.Tech in Computer Science** with
                a specialization in **AI & Machine Learning** from the Future
                Institute of Technology (MAKAUT).
              </span>
            </motion.li>
            <motion.li
              className="flex items-start"
            ...
            >
              ...
              <span>
                In my current role, I build impactful systems like **real-time
                person counters** for crowded scenes, **high-precision hair
                follicle detectors**, and robust **multi-object tracking**
                algorithms using models like YOLOv8 and ResNet50.
              </span>
            </motion.li>
            <motion.li
              className="flex items-start"
            ...
            >
              <span className="mr-4 text-2xl flex-shrink-0">🚀</span>
              <span>
                I am passionate about building **scalable and impactful
                systems** that solve complex, real-world challenges. I thrive on
                learning and applying new technologies to push the boundaries of
